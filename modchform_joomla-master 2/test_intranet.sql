...
--
-- Hôte : localhost
-- Généré le :  jeu. 19 avr. 2018 à 07:19
...
--
-- Base de données :  `test_intranet`
--

-- --------------------------------------------------------

--
-- Structure de la table `job_gest`
--

CREATE TABLE `job_gest` (
  `id` int(11) NOT NULL,
  `gest` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Déchargement des données de la table `job_gest`
--

INSERT INTO `job_gest` (`id`, `gest`) VALUES
(1, 'Encadrant accueil-standard'),
(2, 'Agent d\'accueil'),
(3, 'Secrétaire médical'),
(4, 'Encadrant des secrétariats médicaux'),
(5, 'Technicien d\'information médicale'),
(6, 'Archiviste'),
(7, 'Documentaliste'),
(8, 'Bibliothécaire');
...
--
-- Structure de la table `job_ingen`
--

CREATE TABLE `job_ingen` (
  `id` int(11) NOT NULL,
  `ingen` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Déchargement des données de la table `job_ingen`
--

INSERT INTO `job_ingen` (`id`, `ingen`) VALUES
(1, 'Conducteur de travaux tous corps d\'état'),
(2, 'Dessinateur'),
(3, 'Maçon'),
(4, 'Encadrant maintenance corps d\'état secondaire'),
(5, 'Agent de maintenance générale des bâtiments'),
(6, 'Menuisier-agenceur'),
(7, 'Peintre en bâtiment'),
(8, 'Encadrant maintenance électriques/automatismes\r\n'),
(9, 'Electricien de maintenance\r\n'),
(10, 'Encadrant installation et maintenance des équipement sanitaires et thermiques\r\n'),
(11, 'Electromécanicien mécanicien de maintenance\r\n'),
(12, 'Encadrant de maintenance des équipements et matériels mécaniques\r\n'),
(13, 'Mécanicien de maintenance\r\n'),
(14, 'Encadrant espaces verts\r\n'),
(15, 'Agent d\'entretien des espaces verts\r\n');

-- --------------------------------------------------------

--
-- Structure de la table `job_logis`
--

CREATE TABLE `job_logis` (
  `id` int(11) NOT NULL,
  `logis` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Déchargement des données de la table `job_logis`
--

INSERT INTO `job_logis` (`id`, `logis`) VALUES
(1, 'Gestionnaire des marchés publics'),
(2, 'Acheteur'),
(3, 'Gestionnaire de stocks\r\n'),
(4, 'Responsable logistique\r\n'),
(5, 'Agent de logistique\r\n'),
(6, 'Responsable blanchisserie\r\n'),
(7, 'Encadrant de production en blanchisserie\r\n'),
(8, 'Agent de blanchisserie\r\n'),
(9, 'Lingère, couturière\r\n'),
(10, 'Responsable restauration\r\n'),
(11, 'Encadrant de production culinaire/alimentaire\r\n'),
(12, 'Cuisinier'),
(13, 'Agent de restauration et/ou d\'hôtellerie\r\n'),
(14, 'Conseiller hôtelier\r\n'),
(15, 'Responsable hôtelier\r\n');

-- --------------------------------------------------------

--
-- Structure de la table `job_manag`
--

CREATE TABLE `job_manag` (
  `id` int(11) NOT NULL,
  `manag` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Déchargement des données de la table `job_manag`
--

INSERT INTO `job_manag` (`id`, `manag`) VALUES
(1, 'Responsable des finances\r\n'),
(2, 'Gestionnaire finances comptabilité\r\n'),
(3, 'Contrôleur de gestion\r\n'),
(4, 'Responsable admission frais de séjour\r\n'),
(5, 'Gestionnaire admission frais de séjour\r\n'),
(6, 'Responsable des ressources humaines\r\n'),
(7, 'Chargé de la formation continue\r\n'),
(8, 'Gestionnaire des ressources humaines\r\n'),
(9, 'Chargé communication\r\n'),
(10, 'Webmestre éditorial\r\n'),
(11, 'Secrétaire');

-- --------------------------------------------------------

--
-- Structure de la table `job_medic`
--

CREATE TABLE `job_medic` (
  `id` int(11) NOT NULL,
  `medic` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Déchargement des données de la table `job_medic`
--

INSERT INTO `job_medic` (`id`, `medic`) VALUES
(1, 'Médecin spécialisé en psychiatrie'),
(2, 'Médecin généraliste'),
(3, 'Médecin spécialisé en gériatrie'),
(4, 'Médecin autres spécialités');

-- --------------------------------------------------------

--
-- Structure de la table `job_qual`
--

CREATE TABLE `job_qual` (
  `id` int(11) NOT NULL,
  `qual` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Déchargement des données de la table `job_qual`
--

INSERT INTO `job_qual` (`id`, `qual`) VALUES
(1, 'Coordonateur qualité / gestion des risques\r\n'),
(2, 'Animatrice qualité gestion des risques\r\n'),
(3, 'Hygiéniste'),
(4, 'Encadrant bio-nettoyage\r\n'),
(5, 'Agent de bio-nettoyage\r\n'),
(6, 'Responsable de sécurité\r\n');

-- --------------------------------------------------------

--
-- Structure de la table `job_social`
--

CREATE TABLE `job_social` (
  `id` int(11) NOT NULL,
  `social` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Déchargement des données de la table `job_social`
--

INSERT INTO `job_social` (`id`, `social`) VALUES
(1, 'Responsable socio-éducatif\r\n'),
(2, 'Responsable de crèche\r\n'),
(3, 'Assistant de service social\r\n'),
(4, 'Educateur spécialisé\r\n'),
(5, 'Educateur de jeunes enfants\r\n'),
(6, 'Moniteur-éducateur\r\n'),
(7, 'Aide médico-psychologique\r\n'),
(8, 'Educateur sportif\r\n'),
(9, 'Animateur'),
(10, 'Conseiller en économie sociale et familiale\r\n'),
(11, 'Mandataire judiciaire à la protection des majeurs\r\n'),
(12, 'Accueillant familial\r\n'),
(13, 'Auxiliaire de vie social\r\n'),
(14, 'Psychologue'),
(15, 'Chargé des affaires culturelles\r\n');

-- --------------------------------------------------------

--
-- Structure de la table `job_soins`
--

CREATE TABLE `job_soins` (
  `id` int(11) NOT NULL,
  `soins` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Déchargement des données de la table `job_soins`
--

INSERT INTO `job_soins` (`id`, `soins`) VALUES
(1, 'Cadre d\'unité de soins et activités paramédicales'),
(2, 'Formateur des professionnels de santé\r\n'),
(3, 'Infirmier\r\n'),
(4, 'Aide-soignant\r\n'),
(5, 'Puériculteur'),
(6, 'Auxiliaire de puériculture\r\n'),
(7, 'Diététicien'),
(8, 'Orthophoniste'),
(9, 'Masseur-Kinésithérapeute\r\n'),
(10, 'Ergothérapeute'),
(11, 'Psychomotricien'),
...
--
-- Structure de la table `job_sys`
--

CREATE TABLE `job_sys` (
  `id` int(11) NOT NULL,
  `sys` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Déchargement des données de la table `job_sys`
--

INSERT INTO `job_sys` (`id`, `sys`) VALUES
(1, 'Chargé des applications informatiques'),
(2, 'Développeur informatique'),
(3, 'Chef de projet informatique\r\n'),
(4, 'Expert technique (réseau, système, BDD....)\r\n'),
(5, 'Intervenant / support informatique utilisateurs\r\n'),
(6, 'Exploitant technique\r\n');

-- --------------------------------------------------------

--
-- Structure de la table `sl14k_assets`
--

CREATE TABLE `sl14k_assets` (
...
--
-- Déchargement des données de la table `sl14k_assets`
--

INSERT INTO `sl14k_assets` (`id`, `parent_id`, `lft`, `rgt`, `level`, `name`, `title`, `rules`) VALUES
...
(56, 18, 74, 75, 2, 'com_modules.module.88', 'Super Simple Contact Form', '{}'),
(57, 18, 76, 77, 2, 'com_modules.module.89', 'chform', '{}');

-- --------------------------------------------------------

--
-- Structure de la table `sl14k_associations`
--

CREATE TABLE `sl14k_associations` (
...
--
-- Structure de la table `sl14k_banners`
--

CREATE TABLE `sl14k_banners` (
  `id` int(11) NOT NULL,
...
--
-- Structure de la table `sl14k_banner_clients`
--

CREATE TABLE `sl14k_banner_clients` (
  `id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Structure de la table `sl14k_banner_tracks`
--

CREATE TABLE `sl14k_banner_tracks` (
...
--
-- Structure de la table `sl14k_categories`
--

CREATE TABLE `sl14k_categories` (
  `id` int(11) NOT NULL,
...
--
-- Déchargement des données de la table `sl14k_categories`
--

INSERT INTO `sl14k_categories` (`id`, `asset_id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `extension`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `modified_user_id`, `modified_time`, `hits`, `language`, `version`) VALUES
(1, 0, 0, 0, 11, 0, '', 'system', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{}', '', '', '{}', 697, '2018-04-12 09:00:25', 0, '0000-00-00 00:00:00', 0, '*', 1),
(2, 27, 1, 1, 2, 1, 'uncategorised', 'com_content', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 697, '2018-04-12 09:00:25', 0, '0000-00-00 00:00:00', 0, '*', 1),
(3, 28, 1, 3, 4, 1, 'uncategorised', 'com_banners', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 697, '2018-04-12 09:00:25', 0, '0000-00-00 00:00:00', 0, '*', 1),
(4, 29, 1, 5, 6, 1, 'uncategorised', 'com_contact', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 697, '2018-04-12 09:00:25', 0, '0000-00-00 00:00:00', 0, '*', 1),
(5, 30, 1, 7, 8, 1, 'uncategorised', 'com_newsfeeds', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 697, '2018-04-12 09:00:25', 0, '0000-00-00 00:00:00', 0, '*', 1),
(7, 32, 1, 9, 10, 1, 'uncategorised', 'com_users', 'Uncategorised', 'uncategorised', '', '', 1, 0, '0000-00-00 00:00:00', 1, '{\"category_layout\":\"\",\"image\":\"\"}', '', '', '{\"author\":\"\",\"robots\":\"\"}', 697, '2018-04-12 09:00:25', 0, '0000-00-00 00:00:00', 0, '*', 1);

-- --------------------------------------------------------

--
-- Structure de la table `sl14k_contact_details`
--

CREATE TABLE `sl14k_contact_details` (
  `id` int(11) NOT NULL,
...
--
-- Structure de la table `sl14k_content`
--

CREATE TABLE `sl14k_content` (
...
--
-- Structure de la table `sl14k_contentitem_tag_map`
--

CREATE TABLE `sl14k_contentitem_tag_map` (
...
--
-- Structure de la table `sl14k_content_frontpage`
--

CREATE TABLE `sl14k_content_frontpage` (
...
--
-- Structure de la table `sl14k_content_rating`
--

CREATE TABLE `sl14k_content_rating` (
  `content_id` int(11) NOT NULL DEFAULT '0',
...
--
-- Structure de la table `sl14k_content_types`
--

CREATE TABLE `sl14k_content_types` (
...
--
-- Déchargement des données de la table `sl14k_content_types`
--

INSERT INTO `sl14k_content_types` (`type_id`, `type_title`, `type_alias`, `table`, `rules`, `field_mappings`, `router`, `content_history_options`) VALUES
...
--
-- Structure de la table `sl14k_core_log_searches`
--

CREATE TABLE `sl14k_core_log_searches` (
...
--
-- Structure de la table `sl14k_extensions`
--

CREATE TABLE `sl14k_extensions` (
...
--
-- Déchargement des données de la table `sl14k_extensions`
--

INSERT INTO `sl14k_extensions` (`extension_id`, `package_id`, `name`, `type`, `element`, `folder`, `client_id`, `enabled`, `access`, `protected`, `manifest_cache`, `params`, `custom_data`, `system_data`, `checked_out`, `checked_out_time`, `ordering`, `state`) VALUES
...
(103, 0, 'LIB_JOOMLA', 'library', 'joomla', '', 0, 1, 1, 1, '{\"name\":\"LIB_JOOMLA\",\"type\":\"library\",\"creationDate\":\"2008\",\"author\":\"Joomla! Project\",\"copyright\":\"Copyright (C) 2005 - 2018 Open Source Matters. All rights reserved.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"https:\\/\\/www.joomla.org\",\"version\":\"13.1\",\"description\":\"LIB_JOOMLA_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"joomla\"}', '{\"mediaversion\":\"9a5feb1ab3f364dde5ecd3b6f7f44145\"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(452, 0, 'plg_system_updatenotification', 'plugin', 'updatenotification', 'system', 0, 1, 1, 0, '{\"name\":\"plg_system_updatenotification\",\"type\":\"plugin\",\"creationDate\":\"May 2015\",\"author\":\"Joomla! Project\",\"copyright\":\"Copyright (C) 2005 - 2018 Open Source Matters. All rights reserved.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"3.5.0\",\"description\":\"PLG_SYSTEM_UPDATENOTIFICATION_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"updatenotification\"}', '{\"lastrun\":1524119743}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
(454, 0, 'plg_system_stats', 'plugin', 'stats', 'system', 0, 1, 1, 0, '{\"name\":\"plg_system_stats\",\"type\":\"plugin\",\"creationDate\":\"November 2013\",\"author\":\"Joomla! Project\",\"copyright\":\"Copyright (C) 2005 - 2018 Open Source Matters. All rights reserved.\",\"authorEmail\":\"admin@joomla.org\",\"authorUrl\":\"www.joomla.org\",\"version\":\"3.5.0\",\"description\":\"PLG_SYSTEM_STATS_XML_DESCRIPTION\",\"group\":\"\",\"filename\":\"stats\"}', '{\"mode\":3,\"lastrun\":1523526560,\"unique_id\":\"5ab474f59a0ecf150b97ef7d5f5950f4d2f12731\",\"interval\":12}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
--
-- Structure de la table `sl14k_fields_categories`
--

CREATE TABLE `sl14k_fields_categories` (
...
--
-- Structure de la table `sl14k_fields_groups`
--

CREATE TABLE `sl14k_fields_groups` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `context` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `title` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
...
--
-- Structure de la table `sl14k_fields_values`
--

CREATE TABLE `sl14k_fields_values` (
...
--
-- Structure de la table `sl14k_finder_filters`
--

CREATE TABLE `sl14k_finder_filters` (
...
--
-- Structure de la table `sl14k_finder_links`
--

CREATE TABLE `sl14k_finder_links` (
...
--
-- Structure de la table `sl14k_finder_links_terms0`
--

CREATE TABLE `sl14k_finder_links_terms0` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Structure de la table `sl14k_finder_links_terms1`
--

CREATE TABLE `sl14k_finder_links_terms1` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Structure de la table `sl14k_finder_links_terms2`
--

CREATE TABLE `sl14k_finder_links_terms2` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Structure de la table `sl14k_finder_links_terms3`
--

CREATE TABLE `sl14k_finder_links_terms3` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Structure de la table `sl14k_finder_links_terms4`
--

CREATE TABLE `sl14k_finder_links_terms4` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Structure de la table `sl14k_finder_links_terms5`
--

CREATE TABLE `sl14k_finder_links_terms5` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Structure de la table `sl14k_finder_links_terms6`
--

CREATE TABLE `sl14k_finder_links_terms6` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Structure de la table `sl14k_finder_links_terms7`
--

CREATE TABLE `sl14k_finder_links_terms7` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Structure de la table `sl14k_finder_links_terms8`
--

CREATE TABLE `sl14k_finder_links_terms8` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Structure de la table `sl14k_finder_links_terms9`
--

CREATE TABLE `sl14k_finder_links_terms9` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Structure de la table `sl14k_finder_links_termsa`
--

CREATE TABLE `sl14k_finder_links_termsa` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Structure de la table `sl14k_finder_links_termsb`
--

CREATE TABLE `sl14k_finder_links_termsb` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Structure de la table `sl14k_finder_links_termsc`
--

CREATE TABLE `sl14k_finder_links_termsc` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Structure de la table `sl14k_finder_links_termsd`
--

CREATE TABLE `sl14k_finder_links_termsd` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Structure de la table `sl14k_finder_links_termse`
--

CREATE TABLE `sl14k_finder_links_termse` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Structure de la table `sl14k_finder_links_termsf`
--

CREATE TABLE `sl14k_finder_links_termsf` (
  `link_id` int(10) UNSIGNED NOT NULL,
  `term_id` int(10) UNSIGNED NOT NULL,
  `weight` float UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
-- Structure de la table `sl14k_finder_taxonomy`
--

CREATE TABLE `sl14k_finder_taxonomy` (
  `id` int(10) UNSIGNED NOT NULL,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `title` varchar(255) NOT NULL,
...
--
-- Déchargement des données de la table `sl14k_finder_taxonomy`
--

INSERT INTO `sl14k_finder_taxonomy` (`id`, `parent_id`, `title`, `state`, `access`, `ordering`) VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Structure de la table `sl14k_finder_taxonomy_map`
--

CREATE TABLE `sl14k_finder_taxonomy_map` (
  `link_id` int(10) UNSIGNED NOT NULL,
...
--
-- Structure de la table `sl14k_finder_terms`
--

CREATE TABLE `sl14k_finder_terms` (
  `term_id` int(10) UNSIGNED NOT NULL,
...
--
-- Structure de la table `sl14k_finder_terms_common`
--

CREATE TABLE `sl14k_finder_terms_common` (
  `term` varchar(75) NOT NULL,
  `language` varchar(3) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Déchargement des données de la table `sl14k_finder_terms_common`
--

INSERT INTO `sl14k_finder_terms_common` (`term`, `language`) VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Structure de la table `sl14k_finder_tokens`
--

CREATE TABLE `sl14k_finder_tokens` (
  `term` varchar(75) NOT NULL,
  `stem` varchar(75) NOT NULL,
  `common` tinyint(1) UNSIGNED NOT NULL DEFAULT '0',
  `phrase` tinyint(1) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Structure de la table `sl14k_finder_tokens_aggregate`
--

CREATE TABLE `sl14k_finder_tokens_aggregate` (
  `term_id` int(10) UNSIGNED NOT NULL,
...
--
-- Structure de la table `sl14k_finder_types`
--

CREATE TABLE `sl14k_finder_types` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Structure de la table `sl14k_languages`
--

CREATE TABLE `sl14k_languages` (
...
--
-- Déchargement des données de la table `sl14k_languages`
--

INSERT INTO `sl14k_languages` (`lang_id`, `asset_id`, `lang_code`, `title`, `title_native`, `sef`, `image`, `description`, `metakey`, `metadesc`, `sitename`, `published`, `access`, `ordering`) VALUES
(1, 0, 'en-GB', 'English (en-GB)', 'English (United Kingdom)', 'en', 'en_gb', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Structure de la table `sl14k_menu`
--

CREATE TABLE `sl14k_menu` (
  `id` int(11) NOT NULL,
...
--
-- Déchargement des données de la table `sl14k_menu`
--

INSERT INTO `sl14k_menu` (`id`, `menutype`, `title`, `alias`, `note`, `path`, `link`, `type`, `published`, `parent_id`, `level`, `component_id`, `checked_out`, `checked_out_time`, `browserNav`, `access`, `img`, `template_style_id`, `params`, `lft`, `rgt`, `home`, `language`, `client_id`) VALUES
...
--
-- Structure de la table `sl14k_menu_types`
--

CREATE TABLE `sl14k_menu_types` (
  `id` int(10) UNSIGNED NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Déchargement des données de la table `sl14k_menu_types`
--

INSERT INTO `sl14k_menu_types` (`id`, `asset_id`, `menutype`, `title`, `description`, `client_id`) VALUES
(1, 0, 'mainmenu', 'Main Menu', 'The main menu for the site', 0);

-- --------------------------------------------------------

--
-- Structure de la table `sl14k_messages`
--

CREATE TABLE `sl14k_messages` (
...
--
-- Structure de la table `sl14k_messages_cfg`
--

CREATE TABLE `sl14k_messages_cfg` (
...
--
-- Structure de la table `sl14k_modules`
--

CREATE TABLE `sl14k_modules` (
  `id` int(11) NOT NULL,
  `asset_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Déchargement des données de la table `sl14k_modules`
--

INSERT INTO `sl14k_modules` (`id`, `asset_id`, `title`, `note`, `content`, `ordering`, `position`, `checked_out`, `checked_out_time`, `publish_up`, `publish_down`, `published`, `module`, `access`, `showtitle`, `params`, `client_id`, `language`) VALUES
...
--
-- Structure de la table `sl14k_newsfeeds`
--

CREATE TABLE `sl14k_newsfeeds` (
  `catid` int(11) NOT NULL DEFAULT '0',
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Structure de la table `sl14k_overrider`
--

CREATE TABLE `sl14k_overrider` (
...
--
-- Structure de la table `sl14k_postinstall_messages`
--

CREATE TABLE `sl14k_postinstall_messages` (
...
--
-- Déchargement des données de la table `sl14k_postinstall_messages`
--

INSERT INTO `sl14k_postinstall_messages` (`postinstall_message_id`, `extension_id`, `title_key`, `description_key`, `action_key`, `language_extension`, `language_client_id`, `type`, `action_file`, `action`, `condition_file`, `condition_method`, `version_introduced`, `enabled`) VALUES
...
--
-- Structure de la table `sl14k_redirect_links`
--

CREATE TABLE `sl14k_redirect_links` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Structure de la table `sl14k_schemas`
--

CREATE TABLE `sl14k_schemas` (
  `extension_id` int(11) NOT NULL,
  `version_id` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Déchargement des données de la table `sl14k_schemas`
--

INSERT INTO `sl14k_schemas` (`extension_id`, `version_id`) VALUES
(700, '3.8.6-2018-02-14');

-- --------------------------------------------------------

--
-- Structure de la table `sl14k_session`
--

CREATE TABLE `sl14k_session` (
...
--
-- Déchargement des données de la table `sl14k_session`
--

INSERT INTO `sl14k_session` (`session_id`, `client_id`, `guest`, `time`, `data`, `userid`, `username`) VALUES
('e0pcab1hc5sg3663b2vtei8836', 0, 0, '1524121975', 'joomla|s:1116:\"\";', 697, 'admin');

-- --------------------------------------------------------

--
-- Structure de la table `sl14k_tags`
--

CREATE TABLE `sl14k_tags` (
  `id` int(10) UNSIGNED NOT NULL,
  `parent_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `lft` int(11) NOT NULL DEFAULT '0',
  `rgt` int(11) NOT NULL DEFAULT '0',
...
--
-- Déchargement des données de la table `sl14k_tags`
--

INSERT INTO `sl14k_tags` (`id`, `parent_id`, `lft`, `rgt`, `level`, `path`, `title`, `alias`, `note`, `description`, `published`, `checked_out`, `checked_out_time`, `access`, `params`, `metadesc`, `metakey`, `metadata`, `created_user_id`, `created_time`, `created_by_alias`, `modified_user_id`, `modified_time`, `images`, `urls`, `hits`, `language`, `version`, `publish_up`, `publish_down`) VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 697, '2018-04-12 09:00:25', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Structure de la table `sl14k_template_styles`
--

CREATE TABLE `sl14k_template_styles` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Déchargement des données de la table `sl14k_template_styles`
--

INSERT INTO `sl14k_template_styles` (`id`, `template`, `client_id`, `home`, `title`, `params`) VALUES
...
--
-- Structure de la table `sl14k_ucm_base`
--

CREATE TABLE `sl14k_ucm_base` (
...
--
-- Structure de la table `sl14k_ucm_content`
--

CREATE TABLE `sl14k_ucm_content` (
...
--
-- Structure de la table `sl14k_ucm_history`
--

CREATE TABLE `sl14k_ucm_history` (
...
--
-- Structure de la table `sl14k_updates`
--

CREATE TABLE `sl14k_updates` (
...
--
-- Déchargement des données de la table `sl14k_updates`
--

INSERT INTO `sl14k_updates` (`update_id`, `update_site_id`, `extension_id`, `name`, `description`, `element`, `type`, `folder`, `client_id`, `version`, `data`, `detailsurl`, `infourl`, `extra_query`) VALUES
...
(14, 2, 0, 'Afrikaans', '', 'pkg_af-ZA', 'package', '', 0, '3.8.7.1', '', 'https://update.joomla.org/language/details3/af-ZA_details.xml', '', ''),
...
(59, 2, 0, 'Swahili', '', 'pkg_sw-KE', 'package', '', 0, '3.8.6.1', '', 'https://update.joomla.org/language/details3/sw-KE_details.xml', '', ''),
...
(76, 1, 700, 'Joomla', '', 'joomla', 'file', '', 0, '3.8.7', '', 'https://update.joomla.org/core/sts/extension_sts.xml', '', '');

-- --------------------------------------------------------

--
-- Structure de la table `sl14k_update_sites`
--

CREATE TABLE `sl14k_update_sites` (
...
--
-- Déchargement des données de la table `sl14k_update_sites`
--

INSERT INTO `sl14k_update_sites` (`update_site_id`, `name`, `type`, `location`, `enabled`, `last_check_timestamp`, `extra_query`) VALUES
(1, 'Joomla! Core', 'collection', 'https://update.joomla.org/core/list.xml', 1, 1524119746, ''),
(2, 'Accredited Joomla! Translations', 'collection', 'https://update.joomla.org/language/translationlist_3.xml', 1, 1523967825, ''),
(3, 'Joomla! Update Component Update Site', 'extension', 'https://update.joomla.org/core/extensions/com_joomlaupdate.xml', 1, 1523967825, ''),
(4, 'Super Simple Contact Form', 'extension', 'http://standardcompany.ru/dwn/user-update-contact-form.xml', 1, 1523967826, '');

-- --------------------------------------------------------

--
-- Structure de la table `sl14k_update_sites_extensions`
--

CREATE TABLE `sl14k_update_sites_extensions` (
  `update_site_id` int(11) NOT NULL DEFAULT '0',
  `extension_id` int(11) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Links extensions to update sites';

--
-- Déchargement des données de la table `sl14k_update_sites_extensions`
--

INSERT INTO `sl14k_update_sites_extensions` (`update_site_id`, `extension_id`) VALUES
(1, 700),
(2, 802),
(3, 28),
(4, 10000);
...
--
-- Structure de la table `sl14k_usergroups`
--

CREATE TABLE `sl14k_usergroups` (
  `id` int(10) UNSIGNED NOT NULL COMMENT 'Primary Key',
...
--
-- Déchargement des données de la table `sl14k_usergroups`
--

INSERT INTO `sl14k_usergroups` (`id`, `parent_id`, `lft`, `rgt`, `title`) VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Structure de la table `sl14k_users`
--

CREATE TABLE `sl14k_users` (
  `id` int(11) NOT NULL,
...
--
-- Déchargement des données de la table `sl14k_users`
--

INSERT INTO `sl14k_users` (`id`, `name`, `username`, `email`, `password`, `block`, `sendEmail`, `registerDate`, `lastvisitDate`, `activation`, `params`, `lastResetTime`, `resetCount`, `otpKey`, `otep`, `requireReset`) VALUES
(697, 'Super User', 'admin', 'steve68500@hotmail.fr', '$2y$10$Px.MtaI6iTVVNri8XpyaPuMRUQz5TvA8ow/cDYw3cD/5sLrBZYLq2', 0, 1, '2018-04-12 09:00:26', '2018-04-19 06:35:52', '0', '', '0000-00-00 00:00:00', 0, '', '', 0),
(698, 'Contact test', 'test', 'test@test.fr', '$2y$10$wav62EykAzlwAJufLDvYdOvT9nHRic1tiu6Kbr.B0rbmUadtw4hOy', 0, 0, '2018-04-17 12:28:37', '0000-00-00 00:00:00', '', '{\"admin_style\":\"\",\"admin_language\":\"\",\"language\":\"\",\"editor\":\"\",\"helpsite\":\"\",\"timezone\":\"\"}', '0000-00-00 00:00:00', 0, '', '', 0);

-- --------------------------------------------------------

--
-- Structure de la table `sl14k_user_keys`
--

CREATE TABLE `sl14k_user_keys` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Structure de la table `sl14k_user_notes`
--

CREATE TABLE `sl14k_user_notes` (
  `id` int(10) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT '0',
  `catid` int(10) UNSIGNED NOT NULL DEFAULT '0',
...
--
-- Structure de la table `sl14k_user_profiles`
--

CREATE TABLE `sl14k_user_profiles` (
...
--
-- Structure de la table `sl14k_user_usergroup_map`
--

CREATE TABLE `sl14k_user_usergroup_map` (
  `user_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__users.id',
  `group_id` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT 'Foreign Key to #__usergroups.id'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Déchargement des données de la table `sl14k_user_usergroup_map`
--

INSERT INTO `sl14k_user_usergroup_map` (`user_id`, `group_id`) VALUES
(697, 8),
(698, 2);
...
--
-- Structure de la table `sl14k_utf8_conversion`
--

CREATE TABLE `sl14k_utf8_conversion` (
  `converted` tinyint(4) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Déchargement des données de la table `sl14k_utf8_conversion`
--

INSERT INTO `sl14k_utf8_conversion` (`converted`) VALUES
(2);

-- --------------------------------------------------------

--
-- Structure de la table `sl14k_viewlevels`
--

CREATE TABLE `sl14k_viewlevels` (
  `id` int(10) UNSIGNED NOT NULL COMMENT 'Primary Key',
  `title` varchar(100) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `ordering` int(11) NOT NULL DEFAULT '0',
  `rules` varchar(5120) COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'JSON encoded access control.'
...
--
-- Déchargement des données de la table `sl14k_viewlevels`
--

INSERT INTO `sl14k_viewlevels` (`id`, `title`, `ordering`, `rules`) VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Index pour la table `job_gest`
--
ALTER TABLE `job_gest`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `job_ingen`
--
ALTER TABLE `job_ingen`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `job_logis`
--
ALTER TABLE `job_logis`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `job_manag`
--
ALTER TABLE `job_manag`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `job_medic`
--
ALTER TABLE `job_medic`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `job_qual`
--
ALTER TABLE `job_qual`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `job_social`
--
ALTER TABLE `job_social`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `job_soins`
--
ALTER TABLE `job_soins`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `job_sys`
--
ALTER TABLE `job_sys`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `sl14k_assets`
--
ALTER TABLE `sl14k_assets`
  ADD PRIMARY KEY (`id`),
...
--
-- Index pour la table `sl14k_associations`
--
ALTER TABLE `sl14k_associations`
  ADD PRIMARY KEY (`context`,`id`),
  ADD KEY `idx_key` (`key`);

--
-- Index pour la table `sl14k_banners`
--
ALTER TABLE `sl14k_banners`
  ADD PRIMARY KEY (`id`),
...
--
-- Index pour la table `sl14k_banner_clients`
--
ALTER TABLE `sl14k_banner_clients`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_own_prefix` (`own_prefix`),
  ADD KEY `idx_metakey_prefix` (`metakey_prefix`(100));

--
-- Index pour la table `sl14k_banner_tracks`
--
ALTER TABLE `sl14k_banner_tracks`
...
--
-- Index pour la table `sl14k_categories`
--
ALTER TABLE `sl14k_categories`
  ADD PRIMARY KEY (`id`),
...
--
-- Index pour la table `sl14k_contact_details`
--
ALTER TABLE `sl14k_contact_details`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
...
--
-- Index pour la table `sl14k_content`
--
ALTER TABLE `sl14k_content`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Index pour la table `sl14k_contentitem_tag_map`
--
ALTER TABLE `sl14k_contentitem_tag_map`
...
--
-- Index pour la table `sl14k_content_frontpage`
--
ALTER TABLE `sl14k_content_frontpage`
  ADD PRIMARY KEY (`content_id`);

--
-- Index pour la table `sl14k_content_rating`
--
ALTER TABLE `sl14k_content_rating`
  ADD PRIMARY KEY (`content_id`);

--
-- Index pour la table `sl14k_content_types`
--
ALTER TABLE `sl14k_content_types`
  ADD PRIMARY KEY (`type_id`),
  ADD KEY `idx_alias` (`type_alias`(100));

--
-- Index pour la table `sl14k_extensions`
--
ALTER TABLE `sl14k_extensions`
...
--
-- Index pour la table `sl14k_fields`
--
ALTER TABLE `sl14k_fields`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Index pour la table `sl14k_fields_categories`
--
ALTER TABLE `sl14k_fields_categories`
  ADD PRIMARY KEY (`field_id`,`category_id`);

--
-- Index pour la table `sl14k_fields_groups`
--
ALTER TABLE `sl14k_fields_groups`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`state`),
...
--
-- Index pour la table `sl14k_fields_values`
--
ALTER TABLE `sl14k_fields_values`
  ADD KEY `idx_field_id` (`field_id`),
  ADD KEY `idx_item_id` (`item_id`(191));

--
-- Index pour la table `sl14k_finder_filters`
--
ALTER TABLE `sl14k_finder_filters`
  ADD PRIMARY KEY (`filter_id`);

--
-- Index pour la table `sl14k_finder_links`
--
ALTER TABLE `sl14k_finder_links`
...
--
-- Index pour la table `sl14k_finder_links_terms0`
--
ALTER TABLE `sl14k_finder_links_terms0`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Index pour la table `sl14k_finder_links_terms1`
--
ALTER TABLE `sl14k_finder_links_terms1`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Index pour la table `sl14k_finder_links_terms2`
--
ALTER TABLE `sl14k_finder_links_terms2`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Index pour la table `sl14k_finder_links_terms3`
--
ALTER TABLE `sl14k_finder_links_terms3`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Index pour la table `sl14k_finder_links_terms4`
--
ALTER TABLE `sl14k_finder_links_terms4`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Index pour la table `sl14k_finder_links_terms5`
--
ALTER TABLE `sl14k_finder_links_terms5`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Index pour la table `sl14k_finder_links_terms6`
--
ALTER TABLE `sl14k_finder_links_terms6`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Index pour la table `sl14k_finder_links_terms7`
--
ALTER TABLE `sl14k_finder_links_terms7`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Index pour la table `sl14k_finder_links_terms8`
--
ALTER TABLE `sl14k_finder_links_terms8`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Index pour la table `sl14k_finder_links_terms9`
--
ALTER TABLE `sl14k_finder_links_terms9`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Index pour la table `sl14k_finder_links_termsa`
--
ALTER TABLE `sl14k_finder_links_termsa`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Index pour la table `sl14k_finder_links_termsb`
--
ALTER TABLE `sl14k_finder_links_termsb`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Index pour la table `sl14k_finder_links_termsc`
--
ALTER TABLE `sl14k_finder_links_termsc`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Index pour la table `sl14k_finder_links_termsd`
--
ALTER TABLE `sl14k_finder_links_termsd`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Index pour la table `sl14k_finder_links_termse`
--
ALTER TABLE `sl14k_finder_links_termse`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Index pour la table `sl14k_finder_links_termsf`
--
ALTER TABLE `sl14k_finder_links_termsf`
  ADD PRIMARY KEY (`link_id`,`term_id`),
  ADD KEY `idx_term_weight` (`term_id`,`weight`),
  ADD KEY `idx_link_term_weight` (`link_id`,`term_id`,`weight`);

--
-- Index pour la table `sl14k_finder_taxonomy`
--
ALTER TABLE `sl14k_finder_taxonomy`
  ADD PRIMARY KEY (`id`),
...
--
-- Index pour la table `sl14k_finder_taxonomy_map`
--
ALTER TABLE `sl14k_finder_taxonomy_map`
  ADD PRIMARY KEY (`link_id`,`node_id`),
  ADD KEY `link_id` (`link_id`),
  ADD KEY `node_id` (`node_id`);

--
-- Index pour la table `sl14k_finder_terms`
--
ALTER TABLE `sl14k_finder_terms`
...
--
-- Index pour la table `sl14k_finder_terms_common`
--
ALTER TABLE `sl14k_finder_terms_common`
  ADD KEY `idx_word_lang` (`term`,`language`),
  ADD KEY `idx_lang` (`language`);

--
-- Index pour la table `sl14k_finder_tokens`
--
ALTER TABLE `sl14k_finder_tokens`
  ADD KEY `idx_word` (`term`),
  ADD KEY `idx_context` (`context`);

--
-- Index pour la table `sl14k_finder_tokens_aggregate`
--
ALTER TABLE `sl14k_finder_tokens_aggregate`
  ADD KEY `token` (`term`),
  ADD KEY `keyword_id` (`term_id`);

--
-- Index pour la table `sl14k_finder_types`
--
ALTER TABLE `sl14k_finder_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `title` (`title`);

--
-- Index pour la table `sl14k_languages`
--
ALTER TABLE `sl14k_languages`
...
--
-- Index pour la table `sl14k_menu`
--
ALTER TABLE `sl14k_menu`
  ADD PRIMARY KEY (`id`),
...
--
-- Index pour la table `sl14k_menu_types`
--
ALTER TABLE `sl14k_menu_types`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `idx_menutype` (`menutype`);

--
-- Index pour la table `sl14k_messages`
--
ALTER TABLE `sl14k_messages`
  ADD PRIMARY KEY (`message_id`),
  ADD KEY `useridto_state` (`user_id_to`,`state`);

--
-- Index pour la table `sl14k_messages_cfg`
--
ALTER TABLE `sl14k_messages_cfg`
  ADD UNIQUE KEY `idx_user_var_name` (`user_id`,`cfg_name`);

--
-- Index pour la table `sl14k_modules`
--
ALTER TABLE `sl14k_modules`
  ADD PRIMARY KEY (`id`),
...
--
-- Index pour la table `sl14k_modules_menu`
--
ALTER TABLE `sl14k_modules_menu`
  ADD PRIMARY KEY (`moduleid`,`menuid`);

--
-- Index pour la table `sl14k_newsfeeds`
--
ALTER TABLE `sl14k_newsfeeds`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_access` (`access`),
  ADD KEY `idx_checkout` (`checked_out`),
  ADD KEY `idx_state` (`published`),
...
--
-- Index pour la table `sl14k_overrider`
--
ALTER TABLE `sl14k_overrider`
  ADD PRIMARY KEY (`id`);

--
-- Index pour la table `sl14k_postinstall_messages`
--
ALTER TABLE `sl14k_postinstall_messages`
  ADD PRIMARY KEY (`postinstall_message_id`);

--
-- Index pour la table `sl14k_redirect_links`
--
ALTER TABLE `sl14k_redirect_links`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_old_url` (`old_url`(100)),
  ADD KEY `idx_link_modifed` (`modified_date`);

--
-- Index pour la table `sl14k_schemas`
--
ALTER TABLE `sl14k_schemas`
  ADD PRIMARY KEY (`extension_id`,`version_id`);

--
-- Index pour la table `sl14k_session`
--
ALTER TABLE `sl14k_session`
  ADD PRIMARY KEY (`session_id`),
  ADD KEY `userid` (`userid`),
  ADD KEY `time` (`time`);

--
-- Index pour la table `sl14k_tags`
--
ALTER TABLE `sl14k_tags`
  ADD PRIMARY KEY (`id`),
...
--
-- Index pour la table `sl14k_template_styles`
--
ALTER TABLE `sl14k_template_styles`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_template` (`template`),
  ADD KEY `idx_home` (`home`);

--
-- Index pour la table `sl14k_ucm_base`
--
ALTER TABLE `sl14k_ucm_base`
...
--
-- Index pour la table `sl14k_ucm_content`
--
ALTER TABLE `sl14k_ucm_content`
...
--
-- Index pour la table `sl14k_ucm_history`
--
ALTER TABLE `sl14k_ucm_history`
  ADD PRIMARY KEY (`version_id`),
  ADD KEY `idx_ucm_item_id` (`ucm_type_id`,`ucm_item_id`),
  ADD KEY `idx_save_date` (`save_date`);

--
-- Index pour la table `sl14k_updates`
--
ALTER TABLE `sl14k_updates`
  ADD PRIMARY KEY (`update_id`);

--
-- Index pour la table `sl14k_update_sites`
--
ALTER TABLE `sl14k_update_sites`
  ADD PRIMARY KEY (`update_site_id`);

--
-- Index pour la table `sl14k_update_sites_extensions`
--
ALTER TABLE `sl14k_update_sites_extensions`
  ADD PRIMARY KEY (`update_site_id`,`extension_id`);

--
-- Index pour la table `sl14k_usergroups`
--
ALTER TABLE `sl14k_usergroups`
  ADD PRIMARY KEY (`id`),
...
--
-- Index pour la table `sl14k_users`
--
ALTER TABLE `sl14k_users`
  ADD PRIMARY KEY (`id`),
...
--
-- Index pour la table `sl14k_user_keys`
--
ALTER TABLE `sl14k_user_keys`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `series` (`series`),
  ADD KEY `user_id` (`user_id`);

--
-- Index pour la table `sl14k_user_notes`
--
ALTER TABLE `sl14k_user_notes`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idx_user_id` (`user_id`),
  ADD KEY `idx_category_id` (`catid`);

--
-- Index pour la table `sl14k_user_profiles`
--
ALTER TABLE `sl14k_user_profiles`
  ADD UNIQUE KEY `idx_user_id_profile_key` (`user_id`,`profile_key`);

--
-- Index pour la table `sl14k_user_usergroup_map`
--
ALTER TABLE `sl14k_user_usergroup_map`
  ADD PRIMARY KEY (`user_id`,`group_id`);

--
-- Index pour la table `sl14k_viewlevels`
--
ALTER TABLE `sl14k_viewlevels`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT pour la table `job_gest`
--
ALTER TABLE `job_gest`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT pour la table `job_ingen`
--
ALTER TABLE `job_ingen`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT pour la table `job_logis`
--
ALTER TABLE `job_logis`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT pour la table `job_manag`
--
ALTER TABLE `job_manag`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT pour la table `job_medic`
--
ALTER TABLE `job_medic`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT pour la table `job_qual`
--
ALTER TABLE `job_qual`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT pour la table `job_social`
--
ALTER TABLE `job_social`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT pour la table `job_soins`
--
ALTER TABLE `job_soins`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT pour la table `job_sys`
--
ALTER TABLE `job_sys`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT pour la table `sl14k_assets`
--
ALTER TABLE `sl14k_assets`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=58;

--
-- AUTO_INCREMENT pour la table `sl14k_banners`
--
ALTER TABLE `sl14k_banners`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `sl14k_banner_clients`
--
ALTER TABLE `sl14k_banner_clients`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `sl14k_categories`
--
ALTER TABLE `sl14k_categories`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT pour la table `sl14k_contact_details`
--
ALTER TABLE `sl14k_contact_details`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `sl14k_content`
--
ALTER TABLE `sl14k_content`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `sl14k_content_types`
--
ALTER TABLE `sl14k_content_types`
  MODIFY `type_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT pour la table `sl14k_extensions`
--
ALTER TABLE `sl14k_extensions`
  MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10002;

--
-- AUTO_INCREMENT pour la table `sl14k_fields`
--
ALTER TABLE `sl14k_fields`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `sl14k_fields_groups`
--
ALTER TABLE `sl14k_fields_groups`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `sl14k_finder_filters`
--
ALTER TABLE `sl14k_finder_filters`
  MODIFY `filter_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `sl14k_finder_links`
--
ALTER TABLE `sl14k_finder_links`
  MODIFY `link_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `sl14k_finder_taxonomy`
--
ALTER TABLE `sl14k_finder_taxonomy`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT pour la table `sl14k_finder_terms`
--
ALTER TABLE `sl14k_finder_terms`
  MODIFY `term_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `sl14k_finder_types`
--
ALTER TABLE `sl14k_finder_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `sl14k_languages`
--
ALTER TABLE `sl14k_languages`
  MODIFY `lang_id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT pour la table `sl14k_menu`
--
ALTER TABLE `sl14k_menu`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=102;

--
-- AUTO_INCREMENT pour la table `sl14k_menu_types`
--
ALTER TABLE `sl14k_menu_types`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT pour la table `sl14k_messages`
--
ALTER TABLE `sl14k_messages`
  MODIFY `message_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `sl14k_modules`
--
ALTER TABLE `sl14k_modules`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=90;

--
-- AUTO_INCREMENT pour la table `sl14k_newsfeeds`
--
ALTER TABLE `sl14k_newsfeeds`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `sl14k_overrider`
--
ALTER TABLE `sl14k_overrider`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'Primary Key';

--
-- AUTO_INCREMENT pour la table `sl14k_postinstall_messages`
--
ALTER TABLE `sl14k_postinstall_messages`
  MODIFY `postinstall_message_id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT pour la table `sl14k_redirect_links`
--
ALTER TABLE `sl14k_redirect_links`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `sl14k_tags`
--
ALTER TABLE `sl14k_tags`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT pour la table `sl14k_template_styles`
--
ALTER TABLE `sl14k_template_styles`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT pour la table `sl14k_ucm_content`
--
ALTER TABLE `sl14k_ucm_content`
  MODIFY `core_content_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `sl14k_ucm_history`
--
ALTER TABLE `sl14k_ucm_history`
  MODIFY `version_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `sl14k_updates`
--
ALTER TABLE `sl14k_updates`
  MODIFY `update_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;

--
-- AUTO_INCREMENT pour la table `sl14k_update_sites`
--
ALTER TABLE `sl14k_update_sites`
  MODIFY `update_site_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT pour la table `sl14k_usergroups`
--
ALTER TABLE `sl14k_usergroups`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Primary Key', AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT pour la table `sl14k_users`
--
ALTER TABLE `sl14k_users`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=699;

--
-- AUTO_INCREMENT pour la table `sl14k_user_keys`
--
ALTER TABLE `sl14k_user_keys`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `sl14k_user_notes`
--
ALTER TABLE `sl14k_user_notes`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT pour la table `sl14k_viewlevels`
--
ALTER TABLE `sl14k_viewlevels`
